  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#1A1A1A]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden bg-black">
        ...
        >
          {images.map((src, idx) => (
            <div key={idx} className="w-[100vw] h-full shrink-0 relative">
              <img
                src={src}
      ...
      <motion.div
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 text-gray-400 pointer-events-none z-10"
      >
        <div className="w-6 h-10 border-2 border-gray-200/60 rounded-full flex justify-center p-1 backdrop-blur-xs">
