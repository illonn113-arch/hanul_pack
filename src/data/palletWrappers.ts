...
export const DEFAULT_WRAPPERS: PalletWrapper[] = [
  {
    "id": "standard",
    "title": "기본형 랩핑기",
    ...
    "advantages": [
      { "title": "경제성", "description": "합리적인 가격으로 고성능 랩핑 기능을 제공합니다." },
      { "title": "내구성", "description": "견고한 프레임 설계로 장기간 안정적인 사용이 가능합니다." },
      { "title": "편의성", "description": "누구나 쉽게 조작할 수 있는 직관적인 인터페이스와 현장 상황에 맞게 기판 위치를 왼쪽 or 오른쪽으로 변경할 수 있습니다.\n\n(현장에서도 쉽게 변경이 가능합니다.)" }
    ],
    "customizedInfo": {
  ...
  },
  {
    ...
    "advantages": [
      { "title": "비용 절감", "description": "필름 연신 기능을 통해 필름 사용량을 획기적으로 줄여줍니다." },
      { "title": "포장 품질", "description": "랩의 복원력을 바탕으로 파렛트 적재물을 더욱 단단하게 고정합니다." },
      { "title": "고성능", "description": "연속적인 대량 작업에도 안정적인 성능을 발휘합니다." },
      { "title": "편의성", "description": "누구나 쉽게 조작할 수 있는 직관적인 인터페이스와 현장 상황에 맞게 기판 위치를 왼쪽 or 오른쪽으로 변경할 수 있습니다.\n\n(현장에서도 쉽게 변경이 가능합니다.)" }
    ],
    "customizedInfo": {
      "description": "표준 사양 외에도 고객사의 작업 환경에 맞춘 특수 제작이 가능합니다.",
    ...
    "order": 1,
    "videoUrls": [
      "https://www.youtube.com/embed/KtKSQLOuoj0"
    ]
  },
  {
    "id": "top-press",
    ...
    "advantages": [
      { "title": "안정성", "description": "회전 중 제품이 흔들리거나 쏟아지는 것을 완벽하게 방지합니다." },
      { "title": "범용성", "description": "다양한 높이와 크기의 제품에 맞춰 압착 높이가 자동 조절됩니다." },
      { "title": "안전성", "description": "상단 프레스 하강 시 제품을 감지하는 안전 센서가 기본 탑재되어 있습니다." }
    ],
    "recommendedIndustries": [
      "가벼운 플라스틱 용기 제조 업체",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "기능", "value": "자동 필름 컷팅 및 랩 클램프 기능" },
      { "label": "필름 연신율", "value": "최대 300%" },
      { "label": "턴테이블 직경", "value": "1,500Φ" },
      { "label": "최대 적재 중량", "value": "2,000kg" },
  ...
  },
  {
    ...
    "detailedDescription": "원판 랩핑기는 기둥 없이 턴테이블만으로 구성된 랩핑 보조 장비입니다.",
    "advantages": [
      { "title": "가성비", "description": "최소한의 투자로 수동 랩핑의 노동 강도를 크게 줄여줍니다." },
      { "title": "공간 효율", "description": "기둥이 없어 좁고 낮은 공간에서도 자유롭게 설치 및 사용이 가능합니다." },
      { "title": "내구성", "description": "단순한 구조로 고장이 적고 장기간 안정적인 사용이 보장됩니다." }
    ],
    "customizedInfo": { "description": "표준 사양 외에도 고객사의 작업 환경에 맞춘 특수 제작이 가능합니다.", "items": [ "턴테이블 직경: 최대 3,000 파이(Φ)까지 제작 가능" ] },
    "recommendedIndustries": [],
    "order": 4
  },
  {
    ...
    "advantages": [
      { "title": "공정 최적화", "description": "포장과 계량 공정을 하나로 통합하여 불필요한 이동 시간을 제거하고 물류 흐름을 가속화합니다." },
      { "title": "고정밀 계량", "description": "4개의 독립된 로드셀이 하중을 균등하게 감지하여, 적재물이 한쪽으로 치우쳐도 정확한 중량을 산출합니다." }
    ],
    "customizedInfo": { "description": "표준 사양 외에도 고객사의 작업 환경에 맞춘 특수 제작이 가능합니다.", "items": [ "기둥 높이: 최대 3,200mm까지 제작 가능", "턴테이블 직경: 최대 3,000 파이(Φ)까지 제작 가능" ] },
    "recommendedIndustries": [ "정확한 중량 확인이 필요한 수출 물류 업체" ],
    "order": 5
  }
];
...
export const fetchPalletWrappers = async (): Promise<PalletWrapper[]> => {
  try {
    ...
    if (wrappers.length === 0) {
      console.log('Firestore is empty, using default wrappers');
